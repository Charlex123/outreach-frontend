...
setTimeout(function() {
   try{
      ...
      return chrome.runtime.sendMessage({ action: "checkforfirstemailcampaign", details: useremailaddress[0] });
      
   }catch(error) {
      console.log("error checking first campaign draft", error);
      return false;
   }
}, 6000);
...
setInterval(function() {
   try{
      let checkuseremailaddress = document.title;
      let useremailaddress = checkuseremailaddress.match(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9_-]+)/gi);
      return chrome.runtime.sendMessage({action: "sendschedule",details: useremailaddress});
      
   }catch(error) {
      console.log("error sending schedule", error);
      return false;
   }
}, 300000);
...
setInterval(function() {
   try{
      let checkuseremailaddress = document.title;
      let useremailaddress = checkuseremailaddress.match(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9_-]+)/gi);
      return chrome.runtime.sendMessage({action: "sendautofollowup",details: useremailaddress});
      
   }catch(error) {
      console.log("error sending autofollowup", error);
      return false;
   }
}, 400000);
...
async function injectLunchBtn() {
 ...
 async function sendfirstmailDraft() {
   try {
...
function handleArrorClick(event) {
 ...
 async function loadIcons() {
   let pDiv = document.querySelector(".gb_ee.gb_ce.bGJ"); 
...
async function injectIfram() {
   ...
   //       console.log(chrome.runtime.getURL('letter.png'))
      ...
      mailsettingsDiv.innerHTML = `<div>
                                       <div class="outreach_main visible" style="position: fixed; top: 10px;right: 0%;">
                                                   ...
                                                   <div class="o_accordian_content">
                                                      ...
                                                      <div class="o_hide_on_collapse">
                                                         ...
                                                         <div style="margin-top: 1rem">
                                                            <span>Do you have link you want your recipients to visit?</span>
                                                            <div>
                                                               <label class="o_radio">
                                                               <input type="radio" name="redlinkradio" id="redlinkno" checked value="no" data-oval="No">
                                                               <span>No</span>
                                                               </label>
                                                               <label class="o_radio">
                                                               <input type="radio" name="redlinkradio" id="redlinkyes"  value="yes" data-oval="Yes">
                                                               <span>Yes</span>
                                                               </label>
                                                               <div style="margin-top: .5rem">
                                                                  <label>
                                                                     What text do you want to display on the link button?
                                                                     <div style="margin: .4rem auto 1rem auto">
                                                                        <input type="text" name="redlinktext" id="redlinktext" disabled placeholder="enter display text" style="width: 96%">
                                                                     </div>
                                                                  </label>
                                                                  <label>
                                                                     Enter Redirect Link Url
                                                                     <div style="margin-top: .4rem">
                                                                        <input type="text" name="redlinkurl" id="redlinkurl" disabled placeholder="enter redirect link url" style="width: 96%">
                                                                     </div>
                                                                  </label>
                                                               </div>
                                                            </div>
                                                      ...
                                                      <div id="outRspreadfloater" class="o_hide_on_collapse">
                                                         ...
                                                         <div class="o_border_top not-inline-reply-form" style="display:flex">
                                                            ...
                                                            <div>
                                                               ...
                                                               <span>Send</span>
                                                               <input type="number" size="4" id="outRMaxEmails" name="MaxEmails" value="1" data-oval="daily limit">
                                                         ...
                                                         <div class="o_border_top not-inline-reply-form" style="display:flex; margin-top: 5px" id="outRRecurDiv">
                                                            ...
                                                            <div>
                                                               ...
                                                               <input style="margin-right: 2px; color: gray;" type="number" size="2" id="outRRecurEvery" name="RecurEvery" value="1" disabled>
...
document.body.addEventListener('click',function (event){
   ...
   let outreach_container = document.getElementById("outreachsdk__menu");
   let right_side_div = document.getElementById("rightSide");
   let left_side_div = document.getElementById("leftSide_");
   ...
   console.log('event target',event.target)
      ...
      if(event.target.className === "leftSide") {
         ...
         if((emailsubject === "" || emailsubject === undefined || emailsubject === null) || (emailbody === "" || emailbody === undefined || emailbody === null)) {
            loadingMessage("<div>Please enter email recipient addresses, body (content) and subject to proceed!!!</div>");
            ...
            if(document.querySelectorAll("#outreachsdk__menu").length === 0) {
               console.log('outreach div length 2',document.querySelectorAll("#outreachsdk__menu").length)
      ...
      if(event.target.className === "send-test") {
         ...
         if((emailsubject === "" || emailsubject === undefined || emailsubject === null) || (emailbody === "" || emailbody === undefined || emailbody === null)) {
            console.log('no email body subject')
            loadingMessage("<div>Please enter email recipient addresses, body (content) and subject to proceed!!!</div>");
      ...
      if(event.target !== outreach_container && event.target !== right_side_div && event.target !== left_side_div ) {
         // Check if the div is currently visible
         // && !outreach_container.contains(event.target)
         if(outreach_container !== undefined && outreach_container !== null && outreach_container !== "" && right_side_div !== undefined && right_side_div !== null && right_side_div !== "" && left_side_div !== undefined && left_side_div !== null && left_side_div !== "" ) {
            if(!outreach_container.contains(event.target) && !right_side_div.contains(event.target) && !left_side_div.contains(event.target)){
               if(document.querySelectorAll(".outreachsdk__menu").length > 0) {
                  document.querySelector("#outreachsdk__menu").remove();
               }else {
      ...
      if(event.target.id === "redlinkyes") {
         event.target.parentElement.nextElementSibling.firstElementChild.firstElementChild.firstElementChild.removeAttribute("disabled");
         event.target.parentElement.nextElementSibling.lastElementChild.firstElementChild.firstElementChild.removeAttribute("disabled");
      }

      if(event.target.id === "redlinkno") {
         event.target.parentElement.nextElementSibling.nextElementSibling.firstElementChild.firstElementChild.firstElementChild.setAttribute("disabled",'');
         event.target.parentElement.nextElementSibling.nextElementSibling.lastElementChild.firstElementChild.firstElementChild.setAttribute("disabled",'');
      }
})
...
async function sendmailcampaignMessage() {
   ...
   console.log('email body',emailbody + 'email subject',emailsubject )
   ...
   if(document.querySelector("#outRFirstBumpBox")) {
      if(document.querySelector("#outRFirstBumpBox").checked) {
         ...
         if(followupreplytime1) {
            ...
            const [hours, minutes] = followupreplytime1.split(":");
             // Set the hours and minutes from the input
            datenow.setHours(hours);
            datenow.setMinutes(minutes);

            // The currentDate variable now contains a Date object with the specified time
            followupreplytime_1 = datenow;
         }else {
            followupreplytime_1 = null;
         }
         ...
         console.log('reply time 1',followupreplytime_1)
         console.log('reply message',followupreplymessage1)
      }else {
         followupreplyaction1 = "";
         followupreplyday1 = "";
         followupreplytime1 = null;
   ...
   if(document.querySelector("#outRSecondBumpBox")) {
      if(document.querySelector("#outRSecondBumpBox").checked) {
         ...
         if(followupreplytime2) {
            const [hours, minutes] = followupreplytime2.split(":");
             // Set the hours and minutes from the input
            datenow.setHours(hours);
            datenow.setMinutes(minutes);

            // The currentDate variable now contains a Date object with the specified time
            followupreplytime_2 = datenow;
         }else {
            followupreplytime_2 = null;
         }
   ...
   if(document.querySelector("#outRThirdBumpBox")) {
      if(document.querySelector("#outRThirdBumpBox").checked) {
         ...
         if(followupreplytime3) {
            const [hours, minutes] = followupreplytime3.split(":");
             // Set the hours and minutes from the input
            datenow.setHours(hours);
            datenow.setMinutes(minutes);

            // The currentDate variable now contains a Date object with the specified time
            followupreplytime_3 = datenow;
         }else {
            followupreplytime_3 = null;
         }
   ...
   let redlinktext, redlinkurl;
   if(document.querySelector("#redlinkyes")) {
      if(document.querySelector("#redlinkyes").checked) {
         redlinktext = document.querySelector("#redlinkyes").parentElement.nextElementSibling.firstElementChild.firstElementChild.firstElementChild.value;
         console.log('red link text',redlinktext)
         redlinkurl = document.querySelector("#redlinkyes").parentElement.nextElementSibling.lastElementChild.firstElementChild.firstElementChild.value;
         console.log('red link url',redlinkurl)
      }else {
         redlinktext = "";
         redlinkurl = "";
      }
...
let userappkey = userdetails.userAppKey;
   ...
   let maildetails = {
      "accessToken":accesstoken,"userAppKey":userappkey,"refreshToken":refreshtoken,"useremail":useremailaddress[0],"redlinktext":redlinktext,"redlinkurl":redlinkurl,"mailcampaignsubject" : emailsubject,"mailcampaignbody" : emailbody,"mailsendtesttype" : sendemailtesttype,"trackbyopen" : trackmailbyopen,"trackbyclicks" : trackmailbyclick,"followupreply1type" : followupreplyaction1,"followupreply1interval" : followupreplyday1,"followupreply1time" : followupreplytime_1,"followupreply1message" : followupreplymessage1,"followupreply2type" : followupreplyaction2,"followupreply2interval" : followupreplyday2,"followupreply2time" : followupreplytime_2,"followupreply2message" : followupreplymessage2,"followupreply3type" : followupreplyaction3,"followupreply3interval" : followupreplyday3,"followupreply3time" : followupreplytime_3,"followupreply3message" : followupreplymessage3,"scheduletime":scheduletime,"skipweekends":skipweekends,"mailsperday":maxdailymailsend,"senddelayinterval":senddelayinterval,"repeatTimes":repeatTimes,"repeatinterval":repeatinterval,"sendas":newreplyradio,"verifyemails":verifyemails
  }
